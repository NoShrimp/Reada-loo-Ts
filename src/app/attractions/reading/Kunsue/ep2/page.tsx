    ...
    return (
        <div className="bg-neutral">
            ...
            <div className="navbar-center hidden lg:flex">
                <h3 className="text-lg font-bold mb-2 pt-2">ตำนานสุยอวิ๋นยอดกุนซือ ตอนที่ 2</h3>
            </div>
            <div className="navbar-end pr-4">
            <div className="join">
                <a href="/attractions/reading/Kunsue/ep1" className="join-item btn btn-primary btn-outline rounded-lg">Previous page</a>
                <a href="/attractions/reading/Kunsue/ep2" className="join-item btn btn-secondary btn-outline rounded-lg">Next</a>
            </div>
            </div>
            </div>
            ...
            <div className="flex flex-col items-center my-2 py-2">
                ...
                <div className="w-full max-w-full mx-2 my-4" ref={setContainerRef}>
                    <Document file={'/pdf/Novel/Kunsue/Kunsue2.pdf'} onLoadSuccess={onDocumentLoadSuccess} options={options} className="flex flex-col items-center">
