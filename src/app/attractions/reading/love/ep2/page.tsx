    ...
    return (
        <div className="bg-neutral">
            ...
            <div className="navbar-center hidden lg:flex">
                <h3 className="text-lg font-bold mb-2 pt-2">เสน่ห์รัก ตอนที่ 2</h3>
            </div>
            ...
            <div className="flex flex-col items-center my-2 py-2">
                ...
                <div className="w-full max-w-full mx-2 my-4" ref={setContainerRef}>
                    <Document file={'/pdf/Novel/love/love2.pdf'} onLoadSuccess={onDocumentLoadSuccess} options={options} className="flex flex-col items-center">
